		...
		<div class="container">
			...
			<div id="result_content">
				<div class="operate_info">
					...
					<p id="setBtn"><label><strong>总成绩 = 出勤成绩*</strong><strong id="attendance_ratio"></strong><strong>% + 考试成绩*</strong><strong id="exam_ratio"></strong><strong>%</strong></label><button class="btn btn-default setRatio" data-toggle="modal" data-target="#result_ratio">设置</button></p>
