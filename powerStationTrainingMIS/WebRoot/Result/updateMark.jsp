...
<link rel="stylesheet" href="css/train_result/updateMark.css" />
						...
						<table id="resultInfo_table" class="table table-bordered">
							...
							<tbody>
								<tr>
									...
									<td>发电一部 电气1班</td>
									<td>10</td>
									<td><input type="text" value="20" name="" /></td>
									<td><input type="text" value="80" name="" /></td>
									<td><input type="text" value="100" name="" readonly="readonly" /></td>
								</tr>
								<tr>
									<td>2</td>
									<td>张志刚</td>
									<td>发电一部 电气1班</td>
									<td>10</td>
									<td><input type="text" value="15" name="" /></td>
									<td><input type="text" value="70" name="" /></td>
									<td><input type="text" value="85" name="" readonly="readonly" /></td>
								</tr>
								<tr>
									<td>3</td>
									<td>张志刚</td>
									...
									<td><input type="text" value="15" name="" /></td>
									<td><input type="text" value="70" name="" /></td>
									<td><input type="text" value="85" name="" readonly="" /></td>
								</tr>
								<tr>
									<td>4</td>
									<td>张志刚</td>
