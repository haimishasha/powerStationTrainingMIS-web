...
<script type="text/javascript">
 function link() {
    ...
    var trainPlanids=new Array();
    
   for(var i=0; i<obj.length; i ++){
       if(obj[i].checked){
       trainPlanids.push(obj[i].value);          
        }
    }
   window.location ="${pageContext.request.contextPath}/update.jsp?trainPlanids="+trainPlanids;
 }
	function Delete() {
